...
<div class="form-group">
       <input hidden type="text" name="u_pdt_id" 
       class="form-control" value="<?php echo $pdtInfo['pdt_id']; ?>">
    </div>
<div class="form-group">
       <label for="u_pdt_name">Product Name</label>
       <input type="text" name="u_pdt_name" 
       class="form-control" value="<?php echo $pdtInfo['pdt_name']; ?>">
    </div>
    <div class="form-group">
       <label for="u_pdt_price">Product Price</label>
       <input type="number" name="u_pdt_price" 
       class="form-control" value="<?php echo $pdtInfo['pdt_price']; ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
       ...
       <input type="file" name="u_pdt_image" 
       class="form-control">
    </div>
    <div class="form-group">
